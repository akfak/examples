...
public class Avro_ConsumerExample {
  public static void main(String[] args){
    ...
    props.put("value.deserializer", "io.confluent.kafka.serializers.KafkaProtobufAvroDeserializer");
    props.put("schema.registry.url", url);
    props.put("group.id", "consumer-tutorial");


    KafkaConsumer<String, Serializers.Serializer> consumer = new KafkaConsumer<>(props);
    consumer.subscribe(Arrays.asList("KafkaProtobufAvro"));
